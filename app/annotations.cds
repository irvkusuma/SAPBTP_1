using { irfan_kusuma_f_41Srv } from '../srv/service.cds';

annotate irfan_kusuma_f_41Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate irfan_kusuma_f_41Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate irfan_kusuma_f_41Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate irfan_kusuma_f_41Srv.CustomerMessage with {
...
annotate irfan_kusuma_f_41Srv.CustomerMessage with @UI.LineItem: [
...
annotate irfan_kusuma_f_41Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate irfan_kusuma_f_41Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate irfan_kusuma_f_41Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
